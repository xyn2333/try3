...
# Butterfly constants
BUTTERFLY_SIZES = (50, 50)  # Example size, adjust as needed
BUTTERFLY_SIZE_RANDOMIZE = (0.8, 1.2)  # Random size variation
BUTTERFLY_MOVE_SPEED = {"min": 1, "max": 3}  # Movement speed range
BUTTERFLY_SPAWN_PROBABILITY = 10  # Probability to spawn a butterfly, adjust as needed
